...
public class AuthorsHasAuthorTypesDAOImpl implements IAuthorsHasAuthorTypesDAO {
    ...
    @Override
    public AuthorsHasAuthorTypes addEntity(AuthorsHasAuthorTypes entity) {
    ...
    @Override
    public List<AuthorsHasAuthorTypes> updateEntity(AuthorsHasAuthorTypes entity) {
    ...
    @Override
    public void deleteEntity(Long authorsId) {
    ...
    @Override
    public List<AuthorsHasAuthorTypes> getAll() {
