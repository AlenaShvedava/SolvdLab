...
public class PosterHasProgramDAOImpl extends MySqlDAO implements IPosterHasProgramDAO {
    ...
    @Override
    public PosterHasProgram addEntity(PosterHasProgram entity) throws Exception {
    ...
    @Override
    public List<PosterHasProgram> updateEntity(PosterHasProgram entity) throws Exception {
    ...
    @Override
    public List<PosterHasProgram> getAll() throws Exception {
